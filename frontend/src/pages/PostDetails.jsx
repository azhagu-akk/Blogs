    ...
    <div>
       ...
       <p>{new Date(post.updatedAt).toString().slice(16,24)}</p>
        ...
        <img src={IF+post.photo} className="w-full  mx-auto mt-8" alt=""/>
         <p className="mx-auto mt-8 text-justify">{post.desc}</p>
         ...
         {/* write a comment */}
         <div className="w-full flex flex-col mt-4 md:flex-row mb-8">
          ...
          <button onClick={postComment} className="bg-black text-sm cursor-pointer text-white px-2 py-2 md:w-[20%] mt-4 md:mt-0">Add Comment</button>
         </div>
        </div>}
        {/* <Footer/> */}
    </div>
